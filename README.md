This Python code has been written using Google.Colab for calculating the Posterior Distribution of p given X<sub>1</sub>= x1, . . . , Xn = xn. The problem is explained as follows.
